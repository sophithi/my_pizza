...
class DeliveryController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'delivery_type' => 'required|in:Logistic,Taxi,Customer Self Picking,Us Delivery Company',
            'name_service' => 'nullable|string|max:100',
            'price_of_delivery' => 'nullable|numeric|min:0',

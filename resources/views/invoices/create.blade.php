    ...
    <div class="container-fluid py-4">
                                                ...
                                                <td style="padding: 12px;">
                                                    <form action="{{ route('invoices.store') }}" method="POST"
                                                        ...
                                                        <button type="submit" class="btn btn-sm"
                                                            style="background: #e85d24; color: white; border: none; padding: 6px 12px; border-radius: 6px; cursor: pointer; font-size: 12px;">
                                                            Create Invoice
                                                        </button>
                                                    </form>
                                                </td>
        ...
        @else
            <div class="alert alert-info" role="alert"
                ...
                <i class="fas fa-info-circle"></i> All orders already have invoices. <a href="{{ route('invoices.index') }}"
                    style="color: #004085; font-weight: 600;">View invoices</a>
            </div>
        @endif
    </div>
@endsection
                ...
                <form action="{{ route('customers.update', $customer) }}" method="POST">
                    ...
                    <div style="margin-bottom: 32px; padding-bottom: 24px; border-bottom: 2px solid #e9ecef;">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label" style="font-weight: 600; color: #1a1d29;">Customer Name <span style="color: #dc3545;">*</span></label>
                                    <input type="text" name="name" class="form-control" value="{{ old('name', $customer->name) }}" required placeholder="Enter customer name" style="border-radius: 6px; border: 1px solid #e9ecef; padding: 10px 12px;">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label" style="font-weight: 600; color: #1a1d29;">Type of Customer <span style="color: #dc3545;">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="phone" class="form-control" value="{{ old('phone', $customer->phone) }}" placeholder="+1-234-567-8900" style="border-radius: 6px; border: 1px solid #e9ecef; padding: 10px 12px;">
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="margin-bottom: 32px; padding-bottom: 24px; border-bottom: 2px solid #e9ecef;">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="address" class="form-control" rows="3" placeholder="Enter street address" style="border-radius: 6px; border: 1px solid #e9ecef; padding: 10px 12px;">{{ old('address', $customer->address) }}</textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="city" class="form-control" value="{{ old('city', $customer->city) }}" placeholder="Enter city name" style="border-radius: 6px; border: 1px solid #e9ecef; padding: 10px 12px;">
                                </div>
                            </div>
                    ...
                    <div style="margin-bottom: 32px; padding-bottom: 24px; border-bottom: 2px solid #e9ecef;">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="notes" class="form-control" rows="3" placeholder="Add notes about this customer's status, e.g., 'input data by user' or 'note customer'" style="border-radius: 6px; border: 1px solid #e9ecef; padding: 10px 12px;">{{ old('notes', $customer->notes) }}</textarea>
                    ...
                    <div style="display: flex; gap: 12px; margin-top: 32px; padding-top: 24px; border-top: 1px solid #e9ecef;">
                        ...
                        <a href="{{ route('customers.show', $customer) }}" class="btn" style="background: #f8f9fa; color: #1a1d29; padding: 12px 28px; border-radius: 6px; border: 1px solid #e9ecef; text-decoration: none; font-weight: 600; display: inline-flex; align-items: center; gap: 8px;">

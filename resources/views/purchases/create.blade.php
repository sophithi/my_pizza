...
@section('content')
    ...
    <div class="form-container">
        ...
        <div class="form-header">
            <h1 class="form-title">📦 Record Purchase</h1>
            <p class="form-subtitle">Add a new purchase order</p>
        </div>
            ...
            <form action="{{ route('purchases.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="supplier_name" class="form-input"
                        placeholder="e.g., Fresh Foods Inc, Local Supplier" value="{{ old('supplier_name') }}" required>
                </div>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-submit">Record Purchase</button>

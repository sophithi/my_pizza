    ...
    <div class="dash-wrap">
        ...
        <div class="dash-hero">
            ...
            <div style="position:relative;z-index:1">
                ...
                <p class="dash-hero-sub">ស្វាគមន៍មកកាន់ប្រព័ន្ធគ្រប់គ្រង — Welcome back, <strong
                        style="color:#fff">{{ auth()->user()->name ?? 'Admin' }}</strong></p>
                <p class="dash-hero-time"><i class="fas fa-clock"
                        style="margin-right:4px"></i>{{ now()->setTimezone('Asia/Phnom_Penh')->translatedFormat('l, d F Y • h:i A') }}
                </p>
            </div>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-meta" style="color:#e85d24"><i class="fas fa-chart-line" style="font-size:9px"></i> This
                    month</div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-meta" style="color:#0284c7"><i class="fas fa-calendar-day" style="font-size:9px"></i>
                    {{ $todayOrders ?? 0 }} today</div>
            </div>
            ...
            @if(auth()->user()->isAdmin())
                <div class="stat-card">
                    ...
                    <div class="stat-meta" style="color:#7c3aed"><i class="fas fa-user-check" style="font-size:9px"></i> Active
                    </div>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-meta" style="color:#059669"><i class="fas fa-tag" style="font-size:9px"></i> In catalog
                    </div>
                </div>
            @endif
            ...
            @if(auth()->user()->isAdmin() || auth()->user()->isManager())
                <div class="stat-card">
                    ...
                    <div class="stat-meta" style="color:#0891b2"><i class="fas fa-check-circle" style="font-size:9px"></i>
                        Completed</div>
                </div>
            @endif
            ...
            @if(auth()->user()->isAdmin())
                <div class="stat-card">
                    ...
                    <div class="stat-icon" style="background:#fffbeb;color:#d97706"><i class="fas fa-exclamation-triangle"></i>
                    </div>
                    <div class="stat-label">Low Stock</div>
                    <div class="stat-value">{{ $stats['low_inventory_items'] ?? 0 }}</div>
                    <div class="stat-meta" style="color:#d97706"><i class="fas fa-bell" style="font-size:9px"></i> Attention
                    </div>
                </div>
            @endif
            ...
            @if(auth()->user()->isAdmin() || auth()->user()->isManager())
                <div class="stat-card">
                    ...
                    <div class="stat-icon" style="background:#fef2f2;color:#dc2626"><i class="fas fa-file-invoice-dollar"></i>
                    </div>
                    <div class="stat-label">Pending Payments</div>
                    <div class="stat-value">${{ number_format($stats['pending_payments'] ?? 0, 2) }}</div>
                    <div class="stat-meta" style="color:#dc2626"><i class="fas fa-clock" style="font-size:9px"></i> Needs
                        follow-up</div>
                </div>
            @endif

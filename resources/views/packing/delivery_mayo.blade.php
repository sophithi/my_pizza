...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Hanuman:wght@400;700;900&family=Noto+Sans+Khmer:wght@400;600;700;900&display=swap" rel="stylesheet">
    <style>
        body {
            margin: 0;
            padding: 32px 16px;
        ...
        /* Name */
        .row-name  .row-label { color: #000000; }
        .row-name  .row-value { font-size: 22pt; color: #1a1d29; }

        /* Address */
        .row-addr  .row-label { color: #000000; }
        .row-addr  .row-value { font-size: 20pt; color: #000000; }

        /* Customer phone */
        .row-phone .row-label { color: #000000; }
        .row-phone .row-value { font-size: 22pt; color: #000000; letter-spacing: 1px; }

        /* Sender phone */
        .row-sender .row-label { color: #000000; }
        .row-sender .row-value { font-size: 22pt; color: #000000; letter-spacing: 1px; }
        ...
        .footer-contact strong { color: #000000; }
        ...
        @media print {
            * {
            ...
            .warning-band { background: #f5f5f5 !important; border-bottom: 2px solid #000 !important; }
            .warning-text { color: #000 !important; }
            .warning-band svg { color: #000 !important; }
        }
    </style>
</head>
<body>
    ...
    <div class="sticker">
        ...
        <div class="header">
            ...
            <div class="brand-container">
                <div class="brand-name">ម៉ាយូនេស បន្ទាយឆ្មា</div>
        ...
        <div class="body">
            ...
            <div class="info-row row-sender">
                ...
                <div class="row-divider"></div>
                <div class="row-value">{{ $invoice->order->sender_phone ?? config('app.sender_phone', '012 312 477') }}</div>
            </div>

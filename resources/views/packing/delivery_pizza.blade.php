...
<body>
    <div class="sticker">
        <div class="sticker-header">
            <span class="sticker-title">ALL PRODUCTS DELIVERY</span>
        ...
        <div class="notes-box" style="border-color: #c7d2fe; background: #eef2ff;">
            <div class="notes-label">Sticker Type</div>
            <div class="notes-text" style="font-size: 22px; font-weight: 800; color: #3730a3; text-align: center; text-transform: uppercase; letter-spacing: 1.5px;">
                DELIVERY - ALL PRODUCTS
            </div>
        </div>

        <div class="notes-box" style="border-color: #d1fae5; background: #ecfdf5;">
            <div class="notes-label">Instructions</div>
            <div class="notes-text" style="font-size: 14px; color: #166534;">
                This sticker is for the full order delivery box. Pack all products in this order together.
            </div>
        </div>

        <div class="footer-row" style="flex-direction: column; align-items: flex-start; gap: 6px;">
            <span class="total-items"><strong>Order Type:</strong> All products delivery order</span>

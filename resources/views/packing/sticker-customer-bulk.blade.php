...
<head>
    ...
    <title>ព្រីនច្រើនច្បាប់ ({{ $invoices->count() }})</title>
...
<body>
    ...
    <div class="bulk-banner no-print">
        <span class="bulk-banner-text">
            ...
            ព្រីនច្រើនច្បាប់៖ <strong>{{ $invoices->count() }}</strong> វិក្ក័យបត្រ
        </span>
    ...
    @forelse ($invoices as $invoice)
        ...
        @endphp
        <div class="sticker" id="invoice-content-{{ $invoice->id }}">
    ...
    <div class="no-print action-bar">
        <button class="btn-print" onclick="window.print()">
            <span class="icon">🖨️</span>
            <span>Print All ({{ $invoices->count() }})</span>
        </button>

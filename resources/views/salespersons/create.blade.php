...
@section('title', 'Create Salesperson')
    ...
    <div class="container-fluid py-4">
        <div class="form-card">
            <div class="form-header">
                <h2 class="form-title">បន្ថែមភ្នាក់ងារលក់ថ្មី</h2>
                <p class="form-subtitle">បញ្ចូលព័ត៌មានលម្អិតរបស់ភ្នាក់ងារលក់ខាងក្រោម។</p>
            </div>
                ...
                <div class="form-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="បញ្ចូលឈ្មោះភ្នាក់ងារលក់" required>
                            @error('name')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone') }}" placeholder="បញ្ចូលលេខទូរស័ព្ទ">
                            @error('phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="action-bar">
                        ...
                        <button type="submit" class="btn-submit">បង្កើតភ្នាក់ងារ</button>
                    </div>
                </div>
            </form>
        </div>

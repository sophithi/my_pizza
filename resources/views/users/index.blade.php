            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    <thead style="background: #f8f9fa;">
                        <tr>
                            <th style="padding: 12px; font-weight: 600; font-size: 12px; text-transform: uppercase;">Avatar
                            </th>
                            <th style="padding: 12px; font-weight: 600; font-size: 12px; text-transform: uppercase;">Name
                            </th>
                            <th style="padding: 12px; font-weight: 600; font-size: 12px; text-transform: uppercase;">Email
                            </th>
                            <th style="padding: 12px; font-weight: 600; font-size: 12px; text-transform: uppercase;">Role
                            </th>
                        ...
                        @forelse($users as $user)
                            <tr style="border-bottom: 1px solid #e9ecef;">
                                <td style="padding: 12px;">
                                    ...
                                    @else
                                        <div
                                            style="width: 40px; height: 40px; border-radius: 50%; background: linear-gradient(135deg, #e85d24 0%, #d94a10 100%); color: #fff; display: flex; align-items: center; justify-content: center; font-weight: 600; font-size: 16px;">
                                ...
                                <td style="padding: 12px;">
                                    @if($user->role == 'admin')
                                        <span
                                            style="padding: 4px 12px; border-radius: 20px; font-size: 11px; font-weight: 600; background: #ffebee; color: #c62828;">
                                    ...
                                    @else
                                        <span
                                            style="padding: 4px 12px; border-radius: 20px; font-size: 11px; font-weight: 600; background: #f3e5f5; color: #7b1fa2;">
                                ...
                                <td style="padding: 12px;">
                                    @if($user->is_active)
                                        <span
                                            style="padding: 4px 12px; border-radius: 20px; font-size: 11px; font-weight: 600; background: #d4edda; color: #155724;">
                                            Active
                                        </span>
                                    @else
                                        <span
                                            style="padding: 4px 12px; border-radius: 20px; font-size: 11px; font-weight: 600; background: #f8d7da; color: #721c24;">
                                            Inactive
                                        </span>
                                    @endif
                                </td>
                                <td style="padding: 12px;">
                                    ...
                                    @if(auth()->user()->isAdmin())
                                        ...
                                        <form action="{{ route('users.destroy', $user) }}" method="POST" style="display: inline;"
                                            data-delete="User" data-item-name="{{ $user->name }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"

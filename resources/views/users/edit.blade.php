                    ...
                    <form action="{{ route('users.update', $user) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ old('name', $user->name) }}"
                                required style="border-radius: 6px; border: 1px solid #e9ecef; padding: 10px 12px;">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label" style="font-weight: 600;">Password (Leave blank to keep
                                        current)</label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="profile" class="form-control" rows="3"
                                style="border-radius: 6px; border: 1px solid #e9ecef; padding: 10px 12px;"
                                placeholder="Brief profile or bio">{{ old('profile', $user->profile) }}</textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="profile_image" class="form-control" accept="image/*"
                                style="border-radius: 6px; border: 1px solid #e9ecef; padding: 10px 12px;">
                            <div style="color: #6c757d; font-size: 12px; margin-top: 4px;">Accepted formats: JPEG, PNG, JPG,
                                GIF (Max 2MB)</div>
                        </div>
                        ...
                        <div style="display: flex; gap: 12px; margin-top: 28px;">
                            <button type="submit" class="btn"
                                style="background: linear-gradient(135deg, #e85d24 0%, #d94a10 100%); color: #fff; padding: 10px 24px; border-radius: 6px; border: none; cursor: pointer; font-weight: 600;">

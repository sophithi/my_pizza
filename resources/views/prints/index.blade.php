...
<div class="container-fluid py-4">
    ...
    <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px;">
        <div class="card-body" style="padding: 16px 24px;">
            <form method="GET" action="{{ route('print.index') }}" id="printFilter" style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right">
                                        <a href="{{ route('print.prep', $invoice) }}" target="_blank" class="btn" style="background:#1a1d29;color:white;border:none;padding:6px 10px;border-radius:6px;font-weight:600;margin-right:6px;">
                                            <i class="fas fa-print"></i> រៀបចំទំនិញ
                                        </a>
                                        <a href="{{ route('print.customer', $invoice) }}" target="_blank" class="btn" style="background:#e85d24;color:white;border:none;padding:6px 10px;border-radius:6px;font-weight:600;">

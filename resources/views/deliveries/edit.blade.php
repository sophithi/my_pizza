...
@section('content')
    <div class="form-container">
        <div class="form-header">
            <div>
                <h1 class="form-title">កែការដឹកជញ្ជូន</h1>
            ...
            <div class="form-card">
                <div class="form-grid">
                    <div>
                        ...
                        <div class="form-group">
                            <label>ផ្សេងៗ</label>
                            <textarea name="delivery_desc" class="form-control"
                                rows="4">{{ old('delivery_desc', $delivery->delivery_desc) }}</textarea>
                        ...
                        <div class="form-group" style="margin-bottom: 0;">
                            <label style="display:flex; align-items:center; gap:8px; margin-bottom:0;">
                                <input type="checkbox" name="show_invoice_info" value="1"
                                    {{ old('show_invoice_info', $delivery->show_invoice_info) ? 'checked' : '' }}

    ...
    <div class="col-md-10">
        <div class="card border-0 shadow-sm" style="border-radius: 12px;">
            <div class="card-body" style="padding: 28px;">
                <h3 style="font-size: 20px; font-weight: 700; color: #1a1d29; margin-bottom: 24px;">Create New Order</h3>
                ...
                <form action="{{ route('orders.store') }}" method="POST">
                    ...
                    <div id="customer_info_card" style="display: none; margin-bottom: 24px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="total_amount" step="0.01" class="form-control" value="{{ old('total_amount', '0') }}" required style="border-radius: 6px; border: 1px solid #e9ecef; padding: 10px 12px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="notes" class="form-control" rows="3" style="border-radius: 6px; border: 1px solid #e9ecef; padding: 10px 12px;">{{ old('notes') }}</textarea>
                    </div>

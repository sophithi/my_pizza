...
@push('styles')
    <style>
        ...
        .toolbar .search-box::placeholder {
            color: #adb5bd;
        }
...
@section('content')
    ...
    <div class="summary-row">
        ...
        <div class="summary-card green">
            <div class="label">ចំនួនទឹកប្រាក់គិតជាដុល្លា</div>
    ...
    <div class="toolbar">
        ...
        <button onclick="exportToCSV()" class="btn-export">Export</button>
    </div>
            ...
            <table class="orders-table">
                ...
                <tbody id="tableBody">
                    @forelse($orders as $order)
                        <tr data-id="{{ $order->id }}" data-customer="{{ $order->customer->name }}"
                            ...
                            <td>
                                ...
                                <div class="date-sub">{{ $order->order_date->setTimezone('Asia/Phnom_Penh')->format('h:i A') }}
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="actions">
                                    ...
                                    <button
                                        onclick="deleteOrder({{ $order->id }}, 'ORD-{{ str_pad($order->id, 4, '0', STR_PAD_LEFT) }}')"

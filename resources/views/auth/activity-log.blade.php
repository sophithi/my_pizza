                ...
                <tbody>
                    @foreach($activities as $activity)
                        <tr>
                            ...
                            <td>
                                <div>
                                    {{ $activity->activity_at ? $activity->activity_at->setTimezone('Asia/Phnom_Penh')->translatedFormat('M d, Y h:i:s A') : '' }}
                                </div>
                                <div class="time-ago"
                                    title="{{ $activity->activity_at ? $activity->activity_at->setTimezone('Asia/Phnom_Penh')->format('Y-m-d H:i:s') : '' }}">
